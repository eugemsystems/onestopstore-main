...
const ImageCarousel = ({ images, handleChangeImage, activeImage }) => {
  ...
  return (
    <>
      ...
      >
        {images?.map((img, i) => {
          const isActive = activeImage ? img === activeImage : false;
          return (
            <SwiperSlide key={i + 1} className="group">
              ...
              >
                <div
                  className={`relative h-[76px] w-[76px] overflow-hidden rounded-lg border-2 bg-muted transition-colors ${
                    isActive
                      ? "border-red-600 ring-2 ring-red-600/30"
                      : "border-red-400/70 hover:border-red-600"
                  }`}
                >
                  <Image
                    src={img}
